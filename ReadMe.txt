...
- User can invite new friends (Please note that the server will not send any invitation message to the user email address. When inviting a user needs to know his/her friend’s email address before hand)
